  ...
  return (
    <section className="py-16 min-h-screen text-black">
      <div className="container px-4 mx-auto">
        ...
        >
          <h1 className={`text-4xl md:text-6xl font-bold mb-6 ${pixelFont.className}`}>Problem Statements</h1>
          <div className="flex flex-col md:flex-row justify-center items-center gap-4">
            ...
            />
            <select className="p-2 border rounded w-full md:w-48" onChange={(e) => setSelectedDomain(e.target.value)}>
        ...
        <div className="mt-16 space-y-8">
          {filteredProblems.map((problem) => (
            <Card key={problem.id} className="w-full">
              <CardHeader>
                ...
                <div className="space-y-4">
                  ...
                  {problem.objective && (
                    <div>
                      ...
                      <p className="text-sm">{problem.objective}</p>
                    </div>
                  )}
                  ...
                  {problem.background && (
                    <div>
                      ...
                      <ul className="list-disc pl-5 text-sm">
                        {problem.background.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.solutionOverview && (
                    <div>
                      ...
                      <ul className="list-disc pl-5 text-sm">
                        {problem.solutionOverview.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.objectives && (
                    <div>
                      ...
                      {Array.isArray(problem.objectives) ? (
                        <ul className="list-disc pl-5 text-sm">
                          {problem.objectives.map((item, index) => (
                            <li key={index} className="text-gray-600">
                              {item}
                            </li>
                          ))}
                        ...
                        <p className="text-sm text-gray-600">{problem.objectives}</p>
                      )}
                    </div>
                  )}

                  {problem.keyConsiderations && (
                    <div>
                      <h4 className="font-semibold mb-2">Key Considerations:</h4>
                      <ul className="list-disc pl-5 text-sm">
                        {problem.keyConsiderations.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.expectedSolutionFeatures && (
                    <div>
                      <h4 className="font-semibold mb-2">Expected Solution Features:</h4>
                      <ul className="list-disc pl-5 text-sm">
                        {problem.expectedSolutionFeatures.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.sampleDataset && (
                    <div>
                      <h4 className="font-semibold mb-2">Sample Dataset:</h4>
                      <ul className="list-disc pl-5 text-sm">
                        {problem.sampleDataset.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.expectedOutcomes && (
                    <div>
                      ...
                      <ul className="list-disc pl-5 text-sm">
                        {problem.expectedOutcomes.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.datasetRequired && (
                    <div>
                      <h4 className="font-semibold mb-2">Dataset Required:</h4>
                      <ul className="list-disc pl-5 text-sm">
                        {problem.datasetRequired.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.suggestedTools && (
                    <div>
                      <h4 className="font-semibold mb-2">Suggested Tools:</h4>
                      <ul className="list-disc pl-5 text-sm">
                        {problem.suggestedTools.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
                  ...
                  {problem.expectedSolution && (
                    <div>
                      ...
                      <p className="text-sm">{problem.expectedSolution}</p>
                    </div>
                  )}

                  {problem.evaluationParameters && (
                    <div>
                      <h4 className="font-semibold mb-2">Evaluation Parameters:</h4>
                      <ul className="list-disc pl-5 text-sm">
                        {problem.evaluationParameters.map((item, index) => (
                          <li key={index} className="text-gray-600">
                            {item}
                          </li>
                        ))}
